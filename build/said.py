...
SAID = {
    ...
    # ── the bounty board ──────────────────────────────────────────────────────
    "Bounties": {
        "fi": "Palkkiot", "pt": "Recompensas", "ru": "Задания",
        "zh": "悬赏", "ja": "依頼", "ko": "현상 수배",
        "de": "Kopfgelder", "fr": "Primes", "sp": "Recompensas", "pl": "Zlecenia",
    },
    "Find a quest, or what it asks for…": {
        "fi": "Etsi tehtävä tai mitä se vaatii…",
        "pt": "Procurar uma missão ou o que ela pede…",
        "ru": "Найти задание или то, что в нём нужно…",
        "zh": "查找任务或它的要求…", "ja": "クエストや条件を検索…",
        "ko": "퀘스트나 조건 찾기…",
        "de": "Auftrag oder Aufgabe suchen…",
        "fr": "Chercher une quête ou ce qu'elle demande…",
        "sp": "Buscar una misión o lo que pide…",
        "pl": "Znajdź zadanie lub jego warunek…",
    },
    "The board in Tarethiel posts one of these a day. What each asks for is the game’s own wording.": {
        "fi": "Tarethielin ilmoitustaulu antaa yhden näistä päivässä. Vaatimukset ovat pelin omaa sanamuotoa.",
        "pt": "O quadro em Tarethiel publica uma destas por dia. O que cada uma pede está nas palavras do próprio jogo.",
        "ru": "Доска в Тарэтиэле вывешивает одно из них в день. Что нужно сделать — словами самой игры.",
        "zh": "塔瑞希尔的告示板每天贴出其中一个。要求均取自游戏原文。",
        "ja": "タレシエルの掲示板は毎日この中から一つを出します。条件はゲーム自身の文言です。",
        "ko": "타레시엘의 게시판은 하루에 하나씩 내겁니다. 요구 사항은 게임의 표현 그대로입니다.",
        "de": "Das Brett in Tarethiel hängt täglich einen davon aus. Was verlangt wird, steht im Wortlaut des Spiels.",
        "fr": "Le tableau de Tarethiel en affiche une par jour. Ce qui est demandé est formulé par le jeu lui-même.",
        "sp": "El tablón de Tarethiel publica una al día. Lo que pide cada una está en palabras del propio juego.",
        "pl": "Tablica w Tarethiel wywiesza jedno dziennie. Wymagania podane są słowami samej gry.",
    },
    "Objectives": {
        "fi": "Tavoitteet", "pt": "Objetivos", "ru": "Цели", "zh": "目标",
        "ja": "目標", "ko": "목표", "de": "Ziele", "fr": "Objectifs",
        "sp": "Objetivos", "pl": "Cele",
    },
    "Nothing matches.": {
        "fi": "Ei osumia.", "pt": "Nada corresponde.", "ru": "Ничего не найдено.",
        "zh": "没有匹配项。", "ja": "該当なし。", "ko": "일치하는 것이 없습니다.",
        "de": "Nichts gefunden.", "fr": "Aucun résultat.", "sp": "Sin resultados.",
        "pl": "Brak wyników.",
    },
    "Reset in": {
        "fi": "Nollaukseen", "pt": "Reinicia em", "ru": "Сброс через",
        "zh": "重置还有", "ja": "リセットまで", "ko": "초기화까지",
        "de": "Zurücksetzen in", "fr": "Réinitialisation dans",
        "sp": "Reinicio en", "pl": "Reset za",
    },
    "the board is cleared at 00:00 UTC": {
        "fi": "taulu tyhjennetään klo 00.00 UTC",
        "pt": "o quadro é limpo às 00:00 UTC",
        "ru": "доска обновляется в 00:00 UTC",
        "zh": "告示板在 UTC 00:00 刷新",
        "ja": "掲示板は 00:00 UTC に更新されます",
        "ko": "게시판은 00:00 UTC에 갱신됩니다",
        "de": "das Brett wird um 00:00 UTC geleert",
        "fr": "le tableau est vidé à 00:00 UTC",
        "sp": "el tablón se vacía a las 00:00 UTC",
        "pl": "tablica jest czyszczona o 00:00 UTC",
    },
    "a walkthrough goes here": {
        "fi": "tähän tulee läpipeluu", "pt": "aqui vai um guia",
        "ru": "здесь будет прохождение", "zh": "此处将放攻略视频",
        "ja": "ここに攻略動画が入ります", "ko": "여기에 공략 영상이 들어갑니다",
        "de": "hier kommt eine Anleitung hin", "fr": "un guide viendra ici",
        "sp": "aquí irá una guía", "pl": "tu trafi poradnik",
    },
    "Language": {
        "fi": "Kieli", "pt": "Idioma", "ru": "Язык", "zh": "语言", "ja": "言語",
        "ko": "언어", "de": "Sprache", "fr": "Langue", "sp": "Idioma", "pl": "Język",
    },
    "Show": {
